...
<style>
    ...
    .form-control-pill:focus {
        ...
        border-color: #0d2e4e; /* Azul navy al enfocar */
        box-shadow: 0 0 0 4px rgba(13, 46, 78, 0.1);
    }

    /* Botón Navy */
    .btn-navy {
        background-color: #0d2e4e; /* Azul oscuro de tu marca */
        color: white;
        border-radius: 50px;
        padding: 12px;
        font-weight: 600;
            ...
            <div class="card login-card p-4 bg-white">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        {{-- REMEMBER ME (Opcional, pero recomendado) --}}
                        ...
                        {{-- REDES SOCIALES (Botones visuales) --}}
                        <div class="d-flex justify-content-center gap-3 mb-4">
                            <a href="{{ route('google.login') }}" class="btn btn-outline-light border text-dark rounded-pill d-flex align-items-center gap-2 shadow-sm">
                        ...
                        <div class="text-center small">
                            ...
                            <a href="{{ route('register') }}" class="fw-bold text-decoration-none" style="color: #0d2e4e;">
                                Registrarme
                            </a>
                        </div>
