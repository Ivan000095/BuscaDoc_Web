                ...
                <div class="col-12">
                    <div class="hero-guest text-center shadow-lg position-relative overflow-hidden"
                        ...
                        <div class="d-flex flex-wrap justify-content-center gap-3 position-relative z-1">
                            ...
                            <a href="https://www.dropbox.com/scl/fi/0ji277sj9ezscpzzezhot/buscadoc.apk?rlkey=6pcetenwkjrbrwpweqz81kxg3&st=68c5459l&dl=1" class="btn btn-apk rounded-pill px-4 py-2 fw-bold shadow-sm hover-scale d-flex align-items-center">
