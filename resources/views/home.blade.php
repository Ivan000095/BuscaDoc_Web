...
<div class="container">
    ...
    <div class="row mb-4">
        <div class="col-12">
            {{-- Usamos el color personalizado también en el título --}}
        ...
        <div class="col-12 col-md-6 col-lg-3 mb-4">
            <div class="card h-100 border-50 shadow-sm hover-card">
                <div class="card-body text-center d-flex flex-column justify-content-center align-items-center p-4">
                    ...
                    <a href="{{ route('doctores.index') }}" class="btn btn-custom btn-sm stretched-link mt-2 rounded-pill px-4">Entrar</a>
                </div>
            </div>
        </div>
