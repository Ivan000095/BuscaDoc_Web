                        ...
                        <div class="col-md-12 p-5 d-flex flex-column justify-content-center text-center">
                            ...
                            @guest
                                ...
                                <div class="d-flex gap-3 justify-content-center">
                                    <a href="{{ route('login') }}" class="btn btn-navy rounded-pill px-5 py-2 fw-bold shadow-sm">
                                        Iniciar Sesión
                                    </a>
                                    <a href="{{ route('register') }}" class="btn btn-outline-navy rounded-pill px-5 py-2 fw-bold">
                                        Crear Cuenta
                                    </a>
                                </div>
                            ...
                            @else
                                ...
                                <div class="py-4">
                                    <div class="spinner-border text-navy" role="status" style="width: 3rem; height: 3rem;">
                                        <span class="visually-hidden">Cargando...</span>
                                    </div>
                                    <p class="text-muted small mt-3 animate-pulse">Te estamos redirigiendo a tu panel...</p>
                                </div>
...
<style>
    ...
    .hover-scale:hover { transform: scale(1.05); cursor: default; }
