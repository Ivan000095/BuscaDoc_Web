                        ...
                        <div class="card-body p-0">
                            <div class="row g-0">
                                <div
                                    ...
                                    <span
                                        class="d-block text-uppercase small fw-bold text-muted">{{ $cita->fecha_hora->format('M') }}</span>
                                    <span
                                        class="d-block display-6 fw-bold text-navy">{{ $cita->fecha_hora->format('d') }}</span>
                                ...
                                <div class="col-9 col-md-7 p-3 d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center mb-1">
                                            ...
                                            <span
                                                class="fw-bold text-dark small">{{ $cita->fecha_hora->format('h:i A') }}</span>
                                        </div>
                                ...
                                <div
                                    ...
                                    @elseif($cita->estado == 'confirmada')
                                        ...
                                        <form action="{{ route('citas.status', $cita->id) }}" method="POST" class="w-100 px-2"
                                            ...
                                            <input type="hidden" name="estado" value="cancelada">
                                            <button type="submit"
                                                class="btn btn-danger rounded-pill w-100 shadow-sm hover-scale py-2 fw-bold d-flex align-items-center justify-content-center">
