        ...
        <div class="container">
            <div class="row my-4 mx-1">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('pacientes.create') }}" class="btn btn-primary rounded-5" style="background-color: #00213D!important;">
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="btn-group shadow-sm">
                                        <a href="{{ route('pacientes.edit', $paciente->id) }}" class="btn btn-outline-primary btn-sm">
                    ...
                    <div class="col-md-6 text-center">
                        <div class="card shadow-lg border-0 rounded-4 p-5">
                            <div class="card-body">
                                ...
                                <hr class="my-4">
                                <p class="small text-secondary mb-4">Si crees que esto es un error, contacta al administrador del sistema.</p>
