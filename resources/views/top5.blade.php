<x-layout>
    ...
    <style>
        ...
        .flip-card {
            ...
            height: 350px; /* Ajustado para que quepa el texto abajo */
            perspective: 1000px;
            margin-bottom: 20px;
        }
        ...
        .flip-card-back  .bi-start-fill, .flip-card-back .bi-star {
            font-size: 1.0rem;
            margin:0 2 px;
        }
    ...
    <div class="container py-5">
        ...
        <div class="row justify-content-center">  
            @foreach($doctores as $doctor)
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 flip-card">
                    <div class="flip-card-inner">
                        <div class="flip-card-front card border-0 shadow-sm overflow-hidden">
                            ...
                            <div class="card-body p-3 text-center">
                                <br>
                                <p class="mb-0 text-navy fw-bold">Doctor: <span class="fw-normal">{{ $doctor->user->name }}</span></p>
                            </div>
                        </div>
                        ...
                        <div class="flip-card-back card border-0 shadow-sm p-3 text-center">
                            ...
                            <div class="mb-2 text-warning">
                                @for($i = 1; $i <= 5; $i++)
                                    <i class="bi {{ $i <= round($doctor->promedio_estrellas) ? 'bi-star-fill' : 'bi-star' }}"></i>
                                @endfor
                            </div>
                            <p class="text-navy fw-medium mb-4">{{ $doctor->especialidades->first()->nombre ?? 'Médico general' }}</p>
                            <a href="{{route('doctores.show', $doctor->id)}}" class="btn btn-navy rounded-pill px-4 btn-sm">Más detalles</a>
                        </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 flip-card">
                    <div class="flip-card-inner">
                        <div class="flip-card-front card border-0 shadow-sm overflow-hidden">
                            ...
                            <div class="card-body p-3 text-center">
                                <br>
                                <p class="mb-0 text-dark fw-bold">Farmacia: <span class="fw-normal">{{ $farmacia->nom_farmacia }}</span></p>
                            </div>
                        </div>
                        ...
                        <div class="flip-card-back card border-0 shadow-sm p-3 text-center">
                            ...
                            <div class="mb-2 text-warning">
                                @for($i = 1; $i <= 5; $i++)
                                    <i class="bi {{ $i <= round($farmacia->promedio_estrellas) ? 'bi-star-fill' : 'bi-star' }}"></i>
                                @endfor
                            </div>
                            <a href="{{route('farmacias.detalle', $farmacia->id)}}" class="btn btn-navy rounded-pill px-4 btn-sm">Más detalles</a>
                        </div>
